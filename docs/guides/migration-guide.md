...
1. **Read the [Visual Guide](../getting-started/visual-guide.md)** (5 minutes)
...
- Share the [Visual Guide](../getting-started/visual-guide.md)
...
**Questions?** See [FAQ](../reference/faq.md) | **Need patterns?** See [Common Patterns](patterns.md)
