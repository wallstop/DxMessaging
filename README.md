...
| ------------ | ------------------- |
| Unity | 2,000,257 |
| DxMessaging (GameObject) - Normal | 421,820 |
| DxMessaging (GameObject) - No-Alloc | 432,089 |
| DxMessaging (Component) - No-Alloc | 465,568 |
| DxMessaging (Untargeted) - No-Alloc | 892,437 |
