...
| ------------ | ------------------- | ------------ |
| Unity | 2,745,200 | Yes |
| DxMessaging (GameObject) - Normal | 8,446,200 | No |
| DxMessaging (Component) - Normal | 8,419,600 | No |
| DxMessaging (GameObject) - No-Copy | 9,412,000 | No |
| DxMessaging (Component) - No-Copy | 9,581,800 | No |
| DxMessaging (Untargeted) - No-Copy | 14,975,200 | No |
| Reflexive (One Argument) | 2,854,200 | No |
| Reflexive (Two Arguments) | 2,106,600 | No |
| Reflexive (Three Arguments) | 2,081,200 | No |
...
| ------------ | ------------------- | ------------ |
| Unity | 1,455,400 | Yes |
| DxMessaging (GameObject) - Normal | 5,686,200 | No |
| DxMessaging (Component) - Normal | 5,693,600 | No |
| DxMessaging (GameObject) - No-Copy | 6,397,000 | No |
| DxMessaging (Component) - No-Copy | 6,412,600 | No |
| DxMessaging (Untargeted) - No-Copy | 9,719,800 | No |
| Reflexive (One Argument) | 1,497,600 | No |
| Reflexive (Two Arguments) | 1,220,600 | No |
| Reflexive (Three Arguments) | 1,213,600 | No |
