...
| ------------ | ------------------- |
| Unity | 1,966,429 |
| DxMessaging (GameObject) - Normal | 408,558 |
| DxMessaging (GameObject) - No-Copy | 414,814 |
| DxMessaging (Component) - No-Copy | 451,439 |
| DxMessaging (Untargeted) - No-Copy | 952,495 |
