...
const SCORING_RULES = [
    ...
    },
    {
        ...
        score: 3,
        description: "pass_filenames: false with a files: filter -> still pays the scan cost (no incremental input)",
    },
    {
        id: "always-run",
        score: 5,
    ...
    },
    {
        id: "npm-spawn",
        score: 5,
        description: "Entry contains npm pack/install/exec/test or npm run validate:npm-meta -> heavy npm child process",
    },
    {
        id: "dotnet-no-batch",
        score: 5,
        description: "Entry uses 'dotnet tool run' without require_serial: true -> N file spawns instead of one batched call",
    },
    {
        id: "jest-at-pre-commit",
        score: 5,
        description: "Entry runs Jest (run-managed-jest.js or bare jest) at pre-commit -> tests belong at pre-push",
    },
    {
        id: "npx-cold-start",
        score: 2,
