...
- Tests for message dispatch must be parameterized over MessageKind (see [Tests Must Be Parameterized by Message Kind](./.llm/skills/testing/tests-must-be-parameterized-by-message-kind.md)).
