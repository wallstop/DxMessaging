namespace DxMessaging.Tests.Runtime.Benchmarks
{
    ...
    public sealed class PerformanceTests : MessagingTestBase
    {
        ...
        private void NoCopyGameObject(Stopwatch timer, TimeSpan timeout, SimpleMessageAwareComponent component, ComplexTargetedMessage message)
        {
            int count = 0;
        ...
        private void NoCopyComponent(Stopwatch timer, TimeSpan timeout, SimpleMessageAwareComponent component, ComplexTargetedMessage message)
        {
            int count = 0;
            component.slowComplexTargetedHandler = null;
            component.complexTargetedHandler = null;
        ...
        private void NoCopyUntargeted(Stopwatch timer, TimeSpan timeout, SimpleMessageAwareComponent component, SimpleUntargetedMessage message)
        {
            int count = 0;
